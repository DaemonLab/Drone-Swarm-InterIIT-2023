...
# if __name__ == "__main__":
    ...
    while True:
        ...
        #below list will be replaced by actual dataformat of pose
        pose = ['x','y','z','Theta','Phi','Psi'] # give throttle cmds 
        ...
        # detected_markers = aruco.display(corners, ids, image, [550,192])

        # pose, is_detected, detected_markers = aruco.get_pose(corners, ids, image, [550,192], display=True)
