    ...
    def move( self, IDX , DroneID , Err , ErrI):
        ...
        while temp_target_idx != len(temp_targets)  : #loop till idx just greater than last ele
            ...
            try:
                ...
                if not bool(pose) : # pose is None
                    print(f"-----------------{self.POSEDICT}")
                ...
                elif (not bool(pose))==False: #Pose not None
                ...
                print(f"\nmove , rcmd: {roll_command}, pcmd: {pitch_command}, tcmd:{throttle_command},  yawcmd:{yaw_command}")
