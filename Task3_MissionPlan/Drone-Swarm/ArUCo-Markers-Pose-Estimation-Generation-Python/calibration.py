...
'''
# Refer to this link to understand in depth
# https://docs.opencv.org/4.x/dc/dbb/tutorial_py_calibration.html
#give square size in meters
import numpy as np
import cv2
import os
import argparse
...
def calibrate(dirpath, square_size, width, height, visualize=False):
    ...
    # cv2.TERM_CRITERIA_EPS: stop iterations if epsilon of 0.001 is reached, 
    # cv2.TERM_CRITERIA_MAX_ITER: max number of iterations is 30
